const logoContainer=document.querySelector(".left-container");
//This code make open the index.html home file when click in the logo container of the login page
